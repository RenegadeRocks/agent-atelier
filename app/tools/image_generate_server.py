...
def image_generate_handle_call_tool(name: str, arguments: dict) -> list[TextContent]:
    ...
    prompt = f"{prompt}\n\n[SYSTEM CONSTRAINT]: Generate at {CHANNEL_ASPECT_RATIO} aspect ratio. Compose with the subject in the upper and central area of the frame; keep the lower ~40% of the frame clean, simple background with no important elements — space is reserved there for typography. One unified, single-camera scene. Never split-screen, collage, diptych, or multi-panel compositions — express contrast within a single scene. STYLE ENFORCEMENT: premium advertising-campaign photography, controlled lighting, shallow depth of field, elevated, magazine-quality. PLACE DIGNITY LAW: depict Indian cities, streets, homes and people as vibrant, prosperous, well-kept and aspirational - clean surfaces, fresh paint, healthy confident people, generous light. NEVER default to poverty-coded imagery: dilapidation, grime, dirty hands, dim damp rooms, or 'slum-documentary' framing - regardless of locale, unless the brand's visual register EXPLICITLY asks for grit. --no text, words, letters, signatures, watermarks, raw, candid, documentary, CCTV-style, gritty. Blank screens/blank signs are fine; no readable glyphs anywhere."
