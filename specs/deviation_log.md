...
### 2026-07-06 — caption_compose font fallback omitted macOS paths [P1-B]
...
- **Files:** `ui/studio-floor/*`, `tools/export_floor_state.py`, `tools/floor_serve.py`, `tools/apply_floor_actions.py`, `app/tests/test_p5_b.py` (19 deterministic tests, post-validation: originally logged as 12, actually shipped 13; +6 in the validator-fix round — Origin gate ×3, demo-flag defense ×2, legacy 3-col audit row ×1).
