...
CONTRACTS = [
    ...
    {"id": "P1-A", "phase": "1",
     "read_secs": ["8", "9", "10"],
     "artifacts": ["specs/agents/managing-editor.md", "specs/agents/evergreen-content.md",
                   "specs/agents/research-verification.md", "specs/agents/creative-director.md",
                   "specs/agents/visual-production.md", "specs/agents/publishing-operations.md",
                   "specs/canon/", "specs/skills/"],
    ...
    {"id": "P1-B", "phase": "1",
     ...
     "artifacts": ["specs/schemas/mcp_tool_outputs.schema.json", "specs/schemas/notify_payload.schema.json",
                   "specs/skills/compose-caption/SKILL.md", "specs/canon/visual_engine.md",
                   "tools/reference/paperclip_caption.py"],
    ...
    {"id": "P2-B", "phase": "2",
     "read_secs": ["7", "app-a"],
     "artifacts": ["specs/agents/brand-strategist.md", "specs/skills/intake-interview/SKILL.md",
                   "specs/brand_kit.template.yaml"],
     "read": "§7.1 (intake + first-light), §7.8 (archetype starters), Appendix A",
     "park": "§12.4, §15.4 — later phases"},
    {"id": "P3", "phase": "3",
     "read_secs": ["7", "9", "13", "8"],
     "artifacts": ["specs/agents/offering-content.md", "specs/skills/ledger-lint/SKILL.md",
                   "specs/skills/weekly-digest/SKILL.md", "specs/skills/ledger-audit/SKILL.md",
                   "specs/canon/cadence_plan.md", "specs/canon/content_ledger.md"],
    ...
    {"id": "P4-B", "phase": "4",
     "read_secs": ["14", "15"], "artifacts": ["specs/redteam.md"],
